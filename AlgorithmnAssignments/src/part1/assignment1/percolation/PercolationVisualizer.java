 ...
 *  From that file, it
 *
 *    - Reads the grid size n of the part1.assignment1.percolation system.
...
public class PercolationVisualizer {
	...
	// draw n-by-n part1.assignment1.percolation system
	...
	public static void main(String[] args) {
		...
		int n = in.readInt(); // n-by-n part1.assignment1.percolation system
